...
# 2 этап: Функции
# Функция - 1: Функция понедельника, рассылка итогов в адрес руководства и сотрудников ОРС (ТД + НОРС)
def function_monday():
    main_send_2()
    main_send_3()
...
# Функция - 4: Функция субботы, повторный анализ полученных ПГ от ПО, запись ПГ и реестров в БД
